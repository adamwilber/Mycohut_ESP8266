...
### sets the delay between cycles of reading from the sensor and cycling hardware
clock_cycle = 10
...
def displayOLED(tmp, hum, addr, time):
...
def cycleLighting(hour):
  global lights_on_hour
  global lights_off_hour
  global led_relay
...
while 1 == 1:
  ...
  currentHour = getTime()
  displayOLED(temp, humidity, IP, nowseconds)
  readSensor()
  cycleFogger(humidity)
  cycleLighting(currentHour)
  cycleSterilizer(currentHour)
  getTime()
  sleep(clock_cycle)
